...
namespace RLF.Core.CharacterCreator.Data
{
    ...
    public class CharacterData
    {
        ...
        // ⭐ VEÍCULO
        [XmlElement]
        public CharacterVehicle Vehicle { get; set; }
        ...
        public CharacterData()
        {
            ...
            // Posição padrão (aeroporto)
            LastPositionX = -1037.0f;
            LastPositionY = -2737.0f;
            LastPositionZ = 20.17f;
            LastHeading = 330f;

            // ⭐ NOVO
            Weapons = new CharacterWeapons();
            Vehicle = new CharacterVehicle();
        ...
        public void UpdateLastPosition(float x, float y, float z, float heading)
        {
            LastPositionX = x;
            LastPositionY = y;
            LastPositionZ = z;
